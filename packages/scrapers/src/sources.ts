...
export const SOURCE_REGISTRY: readonly SourceRegistryEntry[] = [
  ...
  {
    id: "reg-rumr",
    label: "Registro Único de Mejora Regulatoria",
    owner: "Consejo Nacional de Competitividad",
    chamber: null,
    coverage:
      "Inventario nacional de iniciativas, institución responsable, etapa y ventanas de consulta publicadas",
    officialUrl: "https://regulaciones.digital.gob.do/",
    cadence: "DAILY",
    required: true,
    status: "ACTIVE",
  },
  ...
  ...[
    [
      ...
      "Cámara de Diputados",
      "DIPUTADOS",
      "Inventario documental completo de la sección oficial; conserva el título literal y no convierte los PDF actualmente rotulados como priorizados en aprobaciones",
    ...
    [
      ...
      "Cámara de Diputados",
      "DIPUTADOS",
      "Inventario completo de actas publicadas, con legislatura, título, fechas y documento oficial",
    ...
    [
      ...
      "Cámara de Diputados",
      "DIPUTADOS",
      "Inventario completo de transcripciones de debates publicadas por sesión",
    ...
    [
      ...
      "Cámara de Diputados",
      "DIPUTADOS",
      "Inventario completo de documentos oficiales de asistencia al Pleno",
      "https://camaradediputados.gob.do/asistencia/",
    ],
    [
      "sen-minutes",
      ...
      "Senado de la República",
      "SENADO",
      "Inventario completo de actas publicadas, con título, fechas y documento oficial",
      "https://www.senadord.gob.do/elaboracion-de-actas/actas-de-sesiones/",
    ],
  ].map(
    ([id, label, owner, chamber, coverage, officialUrl]): SourceRegistryEntry => ({
      id: id!,
      label: label!,
      owner: owner!,
