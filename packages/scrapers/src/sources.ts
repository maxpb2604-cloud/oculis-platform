...
export const SOURCE_REGISTRY: readonly SourceRegistryEntry[] = [
  {
    ...
    chamber: "DIPUTADOS",
    coverage: "Órdenes estructuradas de comisiones del SIL",
    officialUrl: "https://www.diputadosrd.gob.do/sil/sesiones",
  ...
  ),
  {
    ...
    owner: "Cámara de Diputados",
    chamber: "DIPUTADOS",
    coverage: "500 iniciativas recientes al día; barrido completo semanal y en bootstrap/manual",
    officialUrl: "https://www.diputadosrd.gob.do/sil/",
    cadence: "DAILY",
    required: false,
    status: "ACTIVE",
  ...
  },
  {
    ...
    officialUrl: "https://www.senadord.gob.do/senadores/",
    cadence: "WEEKLY",
    required: true,
    status: "ACTIVE",
  },
  {
    ...
    owner: "MISPAS",
    chamber: null,
    coverage: "Colección oficial de normas y reglamentos técnicos",
    officialUrl: "https://repositorio.msp.gob.do/handle/123456789/13",
    cadence: "DAILY",
    required: false,
    status: "ACTIVE",
  },
  ...
  ...[
    ...
    ["feed-prensa", "Consulta de prensa sobre Congreso", "Google News", "https://news.google.com/"],
  ].map(
