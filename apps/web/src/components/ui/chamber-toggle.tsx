      ...
      {OPTIONS.map(({ value: option, Icon }) => {
        ...
        return (
          <button
            ...
            className="inline-flex min-h-11 min-w-0 items-center justify-center gap-2 rounded-[calc(var(--radius-md)-3px)] px-3.5 py-2 text-sm font-semibold transition-colors sm:px-5"
            style={{
